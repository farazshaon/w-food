        ...
        <div className="container mx-auto">
            ...
            <div className='flex items-center xl:h-[960px]'>
                ...
                <div className='w-full xl:max-w-[460px] text-center xl:text-left'>
                    ...
                    className='text-white text-[62px] leading-[84px]'>A taste of <br /> flavours</motion.h1>
                    <motion.p
                    ...
                    whileInView={'show'}
                    viewport={{once: false, amount: 0.4}}
                    className='leading-6 text-white mb-12 max-w-lg mx-auto xl:max-w-none xl:mx-0 text-sm'>Posuere amet, sed vitae condimentum accumsan aliquam et, aliquam. 
                        Tellus in fusce vel gravida lobortis diam dis ut. Bibendum senectus urna,
                         in ultricies sed lorem natoque. Risus pharetra</motion.p>
                    <motion.div
